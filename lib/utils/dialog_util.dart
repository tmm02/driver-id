...
class DialogUtil {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            FlatButton(
              child: Text("Cancel", style: Styles.dialogCancelTextStyle),
              onPressed: () {
                Navigator.of(context).pop();
                if (dialogCallback != null) {
            ...
            FlatButton(
              child: Text("Yes", style: Styles.dialogYesTextStyle),
              onPressed: () {
                Navigator.of(context).pop();
                if (dialogCallback != null) {
                  dialogCallback("Yes");
  ...
  static void textInputDialog(context,
      {String title, Function(String) dialogCallback}) {
